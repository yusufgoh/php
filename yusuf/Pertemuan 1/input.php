...
<body>
    <form action=salam.php method="post"> <!-- menggunakan method post karena dia eksekusi ke file lain, klo ke sndiri kita pakai get .
     dia memanfaatkan cookies yang ada di browser, jadi kalau di refresh pasti akan error. Pertemuan next kita akan masuk ke session. Which will be different ada plugin datepicker
     klo isset () -->
